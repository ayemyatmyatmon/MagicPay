...
<div class=" d-flex justify-content-center">
    <div class="col-md-8">
        <div class="card transferconfirmation p-3">
            ...
            <form method="POST" action="{{url('/scan-and-pay-transfercomplete')}}" id="form">
                ...
                <button type="submit" class="btn btn-theme btn-block my-2 py-2 check-password"> Confirm</button>
            </form>
